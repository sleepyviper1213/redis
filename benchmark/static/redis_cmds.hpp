...
public:
	static const struct redis_cmd *in_word_set(const char *str, size_t len);
};

inline unsigned int gperf::hash(const char *str, size_t len) {
	static const unsigned char asso_values[] = {
		...
		170, 170, 170, 170, 170, 170, 170, 170, 170, 170, 170, 170, 170,
		170, 170, 170, 170, 170, 170, 170, 170, 170, 170, 170, 170, 170,
		0,   40,  10,  85,  0,   110, 40,  77,  50,  170, 0,   15,  50,
		0,   60,  65,  0,   0,   25,  0,   20,  55,  170, 70,  0,   45,
		170, 170, 170, 170, 170, 170, 170, 170, 170, 170, 170, 170, 170,
		170, 170, 170, 170, 170, 170, 170, 170, 170, 170, 170, 170, 170,
		170, 170, 170, 170, 170, 170, 170, 170, 170, 170, 170};
	return len + asso_values[static_cast<unsigned char>(str[2])] +
		   asso_values[static_cast<unsigned char>(str[1])] +
		   asso_values[static_cast<unsigned char>(str[0])];
}

const struct redis_cmd *gperf::in_word_set(const char *str, size_t len) {
	enum {
		TOTAL_KEYWORDS  = 79,
		MIN_WORD_LENGTH = 3,
		MAX_WORD_LENGTH = 16,
...
#endif
	static const struct redis_cmd wordlist[] = {{""},
												{""},
												{""},
												{""},
#line 29 "redis_commands.gperf"
												{"KEYS", 0},
												{""},
...
#line 59 "redis_commands.gperf"
												{"ZINCRBY", 0},
#line 23 "redis_commands.gperf"
												{"DEL", 0},
#line 94 "redis_commands.gperf"
												{"TIME", 0},
#line 45 "redis_commands.gperf"
												{"LPUSH", 0},
#line 31 "redis_commands.gperf"
												{"HSET", 0},
												{""},
												{""},
...
#pragma GCC diagnostic pop
	...
	return static_cast<struct redis_cmd *>(0);
}
